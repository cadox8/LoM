package me.cadox8.LoM.particles;
...
public enum ParticleEffect {
	...
	public static final class ParticlePacket {
		 ...
		 * @see #ParticleEffect(String, int, int, ParticleProperty...) (ParticleEffect, float, float, float, float, int, boolean, ParticleData)
		 */
